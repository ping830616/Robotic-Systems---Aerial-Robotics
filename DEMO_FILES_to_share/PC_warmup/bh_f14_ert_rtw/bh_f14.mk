###########################################################################
## Makefile generated for Simulink model 'bh_f14'. 
## 
## Makefile     : bh_f14.mk
## Generated on : Wed Jun 22 07:56:23 2016
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\bh_f14.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\bh\users_EV\Pres\2016\Academic_Tour\Pres_03_bh_6DOF_quadcopter\PC_warmup
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = bh_f14_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = bh_f14_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\bh_f14.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\bh_f14_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=bh_f14 -DNUMST=3 -DNCSTATES=10 -DHAVESTDIO
...
SRCS = $(START_DIR)\bh_f14_ert_rtw\bh_f14.c $(START_DIR)\bh_f14_ert_rtw\rtGetInf.c $(START_DIR)\bh_f14_ert_rtw\rtGetNaN.c $(START_DIR)\bh_f14_ert_rtw\rt_nonfinite.c

MAIN_SRC = $(START_DIR)\bh_f14_ert_rtw\ert_main.c
...
OBJS = bh_f14.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\bh_f14_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\bh_f14_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
