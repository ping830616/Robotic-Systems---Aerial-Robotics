...
## 
## Makefile     : CLAW.mk
## Generated on : Tue Feb 26 15:58:46 2019
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\CLAW_ert_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=CLAW -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\CLAW_ert_rtw\CLAW.c $(START_DIR)\CLAW_ert_rtw\CLAW_data.c

MAIN_SRC = $(START_DIR)\CLAW_ert_rtw\ert_main.c
...
{$(START_DIR)\CLAW_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CLAW_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
