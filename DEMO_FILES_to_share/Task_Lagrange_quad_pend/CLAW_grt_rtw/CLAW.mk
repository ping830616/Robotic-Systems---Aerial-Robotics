###########################################################################
## Makefile generated for Simulink model 'CLAW'. 
## 
## Makefile     : CLAW.mk
## Generated on : Tue Feb 26 14:49:12 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CLAW.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\bh\users_EV\Pres\2018\EDU_Seminar\PRES_02_Quadcopter\Task_Lagrange_quad_pend
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = CLAW_comp.rsp
CMD_FILE                  = CLAW.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CLAW.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\CLAW_grt_rtw;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=CLAW -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\CLAW_grt_rtw\CLAW.c $(START_DIR)\CLAW_grt_rtw\CLAW_data.c $(START_DIR)\CLAW_grt_rtw\rtGetInf.c $(START_DIR)\CLAW_grt_rtw\rtGetNaN.c $(START_DIR)\CLAW_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj CLAW.obj CLAW_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\CLAW_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CLAW_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
