###########################################################################
## Makefile generated for Simulink model 'CONTROL_SYS'. 
## 
## Makefile     : CONTROL_SYS.mk
## Generated on : Thu Dec 22 12:00:29 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\CONTROL_SYS.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\bh\users_EV\Webinar_proposals\Pres_web_bh_6DOF_quadcopter\Task_DISCRETISE_and_CODE_GEN
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = CONTROL_SYS_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = CONTROL_SYS_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\CONTROL_SYS.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\CONTROL_SYS_ert_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=CONTROL_SYS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\CONTROL_SYS_ert_rtw\CONTROL_SYS.c $(START_DIR)\CONTROL_SYS_ert_rtw\CONTROL_SYS_data.c

MAIN_SRC = $(START_DIR)\CONTROL_SYS_ert_rtw\ert_main.c
...
OBJS = CONTROL_SYS.obj CONTROL_SYS_data.obj
...
{$(START_DIR)\CONTROL_SYS_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\CONTROL_SYS_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
