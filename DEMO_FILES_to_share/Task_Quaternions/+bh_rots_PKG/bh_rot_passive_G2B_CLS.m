classdef bh_rot_passive_G2B_CLS < bh_rots_PKG.bh_vis_DCM_passive_CLS 
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function OBJ = bh_rot_passive_G2B_CLS(dir_cell_list, dir_ang_list, units_str)
            ...
            % inherit from the bh_vis_DCM_passive_CLS class
            OBJ@bh_rots_PKG.bh_vis_DCM_passive_CLS();
        ...
        function animate(OBJ,hax)
           ...
           % use inherited PLOT method from bh_vis_DCM_passive_CLS  
           hax = plot(OBJ,"hax", hax,"tf_show_gframe", false);
           ...
           veh.rotate_and_animate(OBJ, hax);
        end
        %------------------------------------------------------------------
    end
